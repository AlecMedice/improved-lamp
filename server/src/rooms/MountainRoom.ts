...
export class MountainRoom extends Room<GameState> {
  maxClients = 6;
  ...
  onCreate() {
    ...
    if (!ALLOW_DEV_ROLE) console.log("MountainRoom: devRole override disabled (set ALLOW_DEV_ROLE=1 to enable).");
    ...
    console.log("MountainRoom created.");
  }

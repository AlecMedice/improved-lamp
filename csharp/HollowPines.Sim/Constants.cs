namespace HollowPines.Sim
{
    ...
    public static class World
    {
        ...
        public const int TreeCount = 700;
        public const double HillHeight = 14;
        public const uint Seed = 1337;       // shared so every client + the host build an identical forest
    ...
    public static class Player
    {
        ...
        public const double LogSlowFactor = 0.35;     // hunter speed multiplier clambering over a fallen log
        public const double VaultHopSpeed = 4.6;      // upward velocity when a hunter vaults a log
        public const double VaultStaminaCost = 12;    // stamina spent to vault a log
